...
export const getUserPage = async (params: PageParam) => {
  return await request.post({url: `/member/user/cashier/page`, data: params })
}
...
// 更新用户余额与积分
export const updateMoney = async (data: UserVO) => {
  return await request.put({ url: `/member/user/updateMoney`, data })
}
