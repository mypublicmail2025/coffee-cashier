    ...
    <div class="login-container">
      <div class="login-box">
        ...
        <div class="login-type-switch">
          <div
class="switch-item" :class="{active: getLoginState === LoginStateEnum.LOGIN}"
            @click="() => setLoginState(LoginStateEnum.LOGIN)">
            账号登录
          </div>
          <div
class="switch-item" :class="{active: getLoginState === LoginStateEnum.MOBILE}"
            @click="() => setLoginState(LoginStateEnum.MOBILE)">
            手机登录
          </div>
        </div>

        <LoginForm v-if="getLoginState === LoginStateEnum.LOGIN" @login-success="handleLoginSuccess" />
...
.login-container {
  ...
  align-items: center;
  min-height: 100vh;
  background-image: url('@/assets/imgs/login/bg_green.png');
