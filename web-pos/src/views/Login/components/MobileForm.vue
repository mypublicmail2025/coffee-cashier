...
v-model="loginData.loginForm.tenantName" :placeholder="t('login.tenantNamePlaceholder')"
      ...
      <el-row :span="24" class="shop-row mb-6 border ml-10px mr-10px border-gray-200 w-full flex items-center justify-between">
        <el-col :span="3">
...
v-model="loginData.loginForm.code" :placeholder="t('login.codePlaceholder')"
      ...
      <el-col :span="24" style="padding-left: 10px; padding-right: 10px">
        <el-form-item>
          <XButton
:loading="loginLoading" :title="t('login.login')" class="w-[100%] btn-submit" type="primary"
            @click="signIn()" />
        </el-form-item>
      </el-col>
    </el-row>
...
const signIn = async () => {
  ...
  smsVO.loginSms.shopId = loginData.loginForm.shopId
