<template>
  <div class="dashboard-container">
    ...
    <el-row  class="data-cards">
      ...
      <el-card class="data-card" v-for="(card, index) in dataCards" :key="index" :class="card.class">
...
.data-card {
  ...
  &.card-purple {
    background: linear-gradient(154deg, #EC4786 0%, #B955A4 100%);
  }

  &.card-blue {
  background: linear-gradient(154deg, #865EC0 0%, #5144B4 100%);
  }

  &.card-cyan {
    background: linear-gradient(154deg, #56CDF3 0%, #719DE3 100%);
  }

  &.card-green {
  background: linear-gradient(154deg, #4FD4E3 0%, #57C9F6 100%);
  }

  &.card-orange {
    background: linear-gradient(154deg, #FCBC25 0%, #F68057 100%);
  }
}
