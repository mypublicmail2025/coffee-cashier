  ...
  <ContentWrap>
    ...
    <el-form class="-mb-15px" :model="queryParams" ref="queryFormRef" :inline="true" label-width="68px">
      <el-form-item label="门店名称" prop="storeName">
        <el-input
v-model="queryParams.storeName" placeholder="请输入门店名称" clearable @keyup.enter="handleQuery"
          class="!w-240px" />
      </el-form-item>
...
v-model="queryParams.createTime" value-format="YYYY-MM-DD HH:mm:ss" type="daterange"
      ...
      <el-form-item>
        ...
        <el-button type="primary" v-hasPermi="['mall:shop:create']" @click="openForm('create')">
  ...
  <ContentWrap>
    <el-table v-loading="loading" :data="list">
      ...
      <el-table-column label="状态" align="center">
        <template #default="scope">
          <el-tag v-if="scope.row.status" type="success" size="mini">开启</el-tag>
      ...
      <el-table-column label="操作" align="center">
        <template #default="scope">
          <el-button link v-hasPermi="['mall:shop:update']" type="primary" @click="openForm('update', scope.row.id)">
            编辑
          </el-button>
          <el-button link type="danger" v-hasPermi="['mall:shop:delete']" @click="handleDelete(scope.row.id)">
            删除
          </el-button>
        </template>
      </el-table-column>
