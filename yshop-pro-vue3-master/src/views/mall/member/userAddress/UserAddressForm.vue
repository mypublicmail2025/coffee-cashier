  ...
  <Dialog :title="dialogTitle" v-model="dialogVisible">
    ...
    >
      ...
      <el-form-item label="收货人所在省" prop="province">
        <el-input v-model="formData.province" disabled placeholder="请输入收货人所在省" />
      </el-form-item>
      <el-form-item label="收货人所在市" prop="city">
        <el-input v-model="formData.city" disabled placeholder="请输入收货人所在市" />
      </el-form-item>
      <el-form-item label="收货人所在区" prop="district">
        <el-input v-model="formData.district" disabled placeholder="请输入收货人所在区" />
      </el-form-item>
