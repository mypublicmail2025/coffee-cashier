<template>
  <ContentWrap>
    ...
    <el-form-item label="订单状态：">
      <el-radio-group v-model="orderStatus" size="medium" fill="#DC143C" @change="queryOrderStatus">
    ...
    <el-form-item label="支付方式：">
      <el-radio-group v-model="payStatus" size="medium" fill="#FF1493" @change="queryPayStatus">
        <el-radio-button label="">全部</el-radio-button>
...
class="-mb-15px" :model="queryParams" ref="queryFormRef" :inline="true" label-width="68px"
      ...
      <el-form-item label="订单号" prop="orderId">
        <el-input
v-model="queryParams.orderId" placeholder="请输入订单号" clearable @keyup.enter="handleQuery"
          class="!w-240px" />
      </el-form-item>
      <el-form-item label="用户姓名" prop="realName">
        <el-input
v-model="queryParams.realName" placeholder="请输入用户姓名" clearable @keyup.enter="handleQuery"
          class="!w-240px" />
      </el-form-item>
      <el-form-item label="用户电话" prop="userPhone">
        <el-input
v-model="queryParams.userPhone" placeholder="请输入用户电话" clearable @keyup.enter="handleQuery"
          class="!w-240px" />
      </el-form-item>
...
type="success" plain @click="handleExport" :loading="exportLoading"
  ...
  <ContentWrap>
    <el-table v-loading="loading" :data="list" style="width: 100%">
      ...
      <el-table-column label="门店" align="center" prop="storeName" width="190">
        <template #default="scope">
          <span>{{ scope.row.shopDO.storeName }}</span>
        </template>
      </el-table-column>
