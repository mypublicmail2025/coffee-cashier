<template>
  <Dialog :title="dialogTitle" v-model="dialogVisible" width="1000px">
        ...
        <div class="product-list">
          <div class="tableBox">
            ...
            >
              ...
              <el-table-column prop="originalStock" label="库存" />
              ...
              <el-table-column label="活动库存" width="180" align="center">
                <template #default="scope">
                  <el-input-number
                    ...
                    controls-position="right"
                  />
                  <el-popover v-else placement="top-start" title="" :width="380" trigger="hover">
                    <div class="tabBox">
                      <el-table
                        ref="skuTableRef"
    ...
    <template #footer>
      <el-button @click="submitForm" type="primary" v-if="!visitDetail" :disabled="formLoading"
        >确 定</el-button
      >
  ...
  <set-product ref="setProductRef" @change-specification="changeSpecification" />
</template>
...
/** 打开弹窗 */
const open: (type: string, id?: number, disabled?: boolean) => Promise<void> = async (
  type,
  id,
  disabled
) => {
